...
import { ERROR_TEXTS } from '@/lib/utils/error';
import { FORM_MODE } from '@/lib/utils/enum';
import { getDataSourceName } from '@/lib/utils/dataSourceType';
import useModalAction, { ModalAction } from '@/hooks/useModalAction';
import SQLEditor from '@/components/editor/SQLEditor';
import { parseGraphQLError } from '@/lib/utils/errorHandler';
import { createSQLPairQuestionValidator } from '@/lib/utils/validator';
import ErrorCollapse from '@/components/common/feedback/ErrorCollapse';
import PreviewData from '@/components/dataPreview/PreviewData';
import ImportDataSourceSQLModal, {
  isSupportSubstitute,
} from '@/components/modals/ImportDataSourceSQLModal';
import { usePreviewSqlMutation } from '@/lib/apollo/client/graphql/sql.generated';
import { useGetSettingsQuery } from '@/lib/apollo/client/graphql/settings.generated';
import { useGenerateQuestionMutation } from '@/lib/apollo/client/graphql/sql.generated';
import { SqlPair } from '@/lib/apollo/client/graphql/__types__';
