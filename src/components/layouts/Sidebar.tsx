...
const navigation = [
  ...
  // AI & Data Intelligence
  {
    ...
    items: [
      { name: 'Wren AI Chat', href: '/wren-ai-chat', icon: Brain, permission: 'canViewAnalytics', badge: 'AI' },
      { name: 'Data Modeling', href: '/data-modeling', icon: Network, permission: 'canViewAnalytics' },
      { name: 'Data Setup', href: '/data-setup', icon: Server, permission: 'canViewAnalytics' },
      { name: 'Wren AI Demo', href: '/wren-ai-demo', icon: TestTube, permission: 'canViewAnalytics', badge: 'Demo' },
    ]
  },
  // Data & Content
  {
